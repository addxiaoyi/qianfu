ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "currency" TEXT NOT NULL DEFAULT 'CNY';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "tax_included" BOOLEAN NOT NULL DEFAULT true;
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "additional_fees" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "validity_text" TEXT NOT NULL DEFAULT '长期有效，具体以商品说明为准';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "delivery_method" TEXT NOT NULL DEFAULT '数字下载';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "delivery_eta" TEXT NOT NULL DEFAULT '支付确认后自动交付';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "compatibility" TEXT NOT NULL DEFAULT '请查看商品描述中的兼容性说明';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "is_platform_operated" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "seller_identity" TEXT NOT NULL DEFAULT '';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "after_sales_contact" TEXT NOT NULL DEFAULT '平台工单';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "refund_terms" TEXT NOT NULL DEFAULT '适用平台退款政策';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "ip_source" TEXT NOT NULL DEFAULT '卖家声明拥有合法权利或授权';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "prohibited_use" TEXT NOT NULL DEFAULT '禁止侵权、转售或违法用途';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "risk_notice" TEXT NOT NULL DEFAULT '请在兼容环境中使用并自行备份';
ALTER TABLE "MarketplaceProduct" ADD COLUMN IF NOT EXISTS "product_version" TEXT NOT NULL DEFAULT '1.0.0';
