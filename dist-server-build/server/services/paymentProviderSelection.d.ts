...
export declare const resolvePaymentProviderCandidates: ({ paymentMethod, requestedProvider, primaryProvider, backupProvider, }: PaymentProviderSelectionInput) => PaymentProvider[];
