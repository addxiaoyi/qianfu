...
const ZERO_WIDTH = /[\u200B-\u200F\u2060\uFEFF]/g;
const ALLOWED_ORIGINS = new Set(['https://mc-u.top', 'https://www.mc-u.top']);
...
export function normalizeAiInput(value) {
    return value
        .normalize('NFKC')
        .replace(ZERO_WIDTH, '')
        .replace(/[\s._\-/\\|]+/g, ' ')
...
export function inspectAiInput(value) {
...
export function containsSensitiveAiOutput(value) {
    const normalized = normalizeAiInput(value);
...
export function aiWebOriginGuard(req, res, next) {
    ...
    if (allowedOrigin && allowedSite && client === 'qianfu-web-v1')
        return next();
...
export function auditBlockedAiInput(req, code) {
...
//# sourceMappingURL=aiAbuseGuard.js.map