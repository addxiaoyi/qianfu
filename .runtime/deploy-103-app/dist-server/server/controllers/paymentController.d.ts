...
type UpstreamProvider = 'paypro' | 'xpay' | 'tpay' | 'hupijiao';
...
type ExternalCreateResult = PayProCreateResult | XpayCreateResult | TpayCreateResult | HupijiaoCreateResult;
...
export declare const completeExternalPayment: (req: Request, paymentId: string, options?: CompleteExternalPaymentOptions) => Promise<ExternalNotifyResult>;
