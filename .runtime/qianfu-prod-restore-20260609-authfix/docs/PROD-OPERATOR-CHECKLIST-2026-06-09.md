...
当前线上已恢复。2026-06-09 15:08 本机完整公网验收 `failed_count=0`，报告为 `output/prod-public-verify/verify-public-20260609-150833.json`。
...
- `https://mc-u.top/assets/index-CHZmvcH-.js` 是 `200`
...
预期这些路径部署后不再是 Nginx/Express 404；未登录的资料页改密可以是 401，忘记密码请求应返回统一成功或校验错误。
