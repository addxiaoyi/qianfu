...
import { listUsers, updateUserRole, updateUserEmailVerification, getUserStats, getAvailableRoles } from '../controllers/userManagementController.js';
...
import { setupSoleAdminSchema, userEmailVerificationUpdateSchema, userIdParamSchema, userQuerySchema, userRoleUpdateSchema } from '../utils/validation.js';
const router = Router();
