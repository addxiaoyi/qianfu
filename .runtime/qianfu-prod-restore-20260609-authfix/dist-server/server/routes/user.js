...
import { getProfile, updateProfile, listBioVersions } from '../controllers/userController.js';
import { changePassword } from '../controllers/authController.js';
import { getCheckinStatus, postCheckin } from '../controllers/userLevelController.js';
import { authenticate } from '../middleware/auth.js';
import { csrfProtection } from '../middleware/csrf.js';
import { userLimiter } from '../middleware/rateLimiter.js';
import { validateBody, validateQuery } from '../middleware/requestValidation.js';
import { bioVersionQuerySchema, changePasswordSchema, profileUpdateSchema } from '../utils/validation.js';
const router = Router();
/**
 * @swagger
 * /api/user/profile:
