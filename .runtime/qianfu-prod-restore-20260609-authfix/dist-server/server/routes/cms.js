...
import { getPage, saveDraft, submitReview, rejectReview, publish, unlock, listVersions, rollbackVersion, listAudit, } from '../controllers/cmsController.js';
import { authenticate, hasPermission } from '../middleware/auth.js';
import { csrfProtection } from '../middleware/csrf.js';
import { cmsLimiter, cmsStrictLimiter } from '../middleware/rateLimiter.js';
const router = Router();
