...
import { getLlmsTxt, getRobotsTxt, getSitemapXml } from '../controllers/seoController.js';
...
const publicCmsGuard = (req, res, next) => {
...
export function registerProxyRoutes(app) {
    app.use('/api/public/cms', publicCmsGuard, createProxyMiddleware({
