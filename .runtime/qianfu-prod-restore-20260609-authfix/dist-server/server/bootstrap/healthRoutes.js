...
import { isSafeHostname, mcStatusDirectTestSchema, validateHost } from '../utils/validation.js';
...
function createSignedCsrfToken(token, secret) {
...
function isCacheReadyStatus(cacheStatus) {
...
export function registerHealthRoutes(app) {
    ...
    app.get(`${API_PREFIX}/test-mcstatus-direct`, async (req, res) => {
        ...
        try {
            ...
            fs.writeFileSync(errorLogPath, `Timestamp: ${new Date().toISOString()}\nURL: ${url}\nError: ${error.message}\n\n`, { flag: 'a' });
