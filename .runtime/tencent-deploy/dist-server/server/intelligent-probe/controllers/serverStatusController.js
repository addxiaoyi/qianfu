import * as serverStatusService from '../services/serverStatusService.js';
...
export const createServerStatusController = async (req, res, next) => {
    try {
...
export const getServerStatusByIdController = async (req, res, next) => {
    try {
...
export const getServerStatusByServerIdController = async (req, res, next) => {
    try {
...
export const updateServerStatusController = async (req, res, next) => {
    try {
        const idParam = req.params.id;
        const idStr = Array.isArray(idParam) ? idParam[0] : idParam;
        const id = parseInt(idStr, 10);
...
export const deleteServerStatusController = async (req, res, next) => {
    try {
        const idParam = req.params.id;
        const idStr = Array.isArray(idParam) ? idParam[0] : idParam;
        const id = parseInt(idStr, 10);
...
//# sourceMappingURL=serverStatusController.js.map