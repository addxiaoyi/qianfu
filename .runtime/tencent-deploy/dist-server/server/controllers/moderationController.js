...
import { updateModerationConfigSchema, moderationLogQuerySchema, idParamSchema, reviewModerationLogSchema } from '../utils/validation.js';
export const getModerationConfig = async (req, res, next) => {
    try {
...
export const updateModerationConfig = async (req, res, next) => {
    try {
