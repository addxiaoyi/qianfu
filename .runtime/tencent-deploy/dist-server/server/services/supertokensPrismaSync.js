...
import { DEFAULT_PERMISSION_GROUP, getDefaultPermissions } from '../config/permissionGroups.js';
import { hookService, MotiaHook } from './hookService.js';
import { redisService } from './redisService.js';
const USER_CACHE_PREFIX = 'user:cache:';
/**
 * 将 SuperTokens 用户与 Prisma User 绑定（按 stUserId 或邮箱去重），并维护登录统计。
 */
export async function syncPrismaUserFromSuperTokens(stUserId, email, meta) {
...
export async function repairPrismaUserIfMissing(stUserId) {
...
//# sourceMappingURL=supertokensPrismaSync.js.map