...
2026-06-09 14:24 复核：当前收到的密码已测试 `root/www/admin/add/ubuntu/deploy/qianfu`，SSH 均认证失败；FTP 端口虽开放，但 Pure-FTPd 返回 `421 Unable to read the indexed puredb file`，说明 FTP 服务端用户库当前异常，不能作为恢复通道。
