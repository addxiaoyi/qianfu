...
export function createSessionReference(userId, sessionHandle) {
    const digest = crypto
...
export function resolveSessionHandle(userId, sessionReference, sessionHandles) {
...
//# sourceMappingURL=sessionReference.js.map