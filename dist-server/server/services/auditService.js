...
export async function logAction(userId, action, target, req, details) {
    try {
 ...
 */
export async function logDataChange(userId, action, target, req, before, after) {
 ...
 * Batch audit logging
 */
export async function logBatchActions(actions) {
    try {
