...
export class AlertManagerApiClient {
    ...
    async getAlerts(active = true) {
        try {
            ...
            logger.error('[AlertManager] Failed to get alerts:', error.message);
            return [];
        }
    }
    async getAlertGroups() {
        try {
            ...
            logger.error('[AlertManager] Failed to get alert groups:', error.message);
            return [];
        }
    }
    async setSilence(matchers, durationMinutes) {
        try {
            ...
            logger.error('[AlertManager] Failed to set silence:', error.message);
            return null;
        }
    }
    async deleteSilence(silenceId) {
        try {
            ...
            logger.error('[AlertManager] Failed to delete silence:', error.message);
            return false;
        }
    }
