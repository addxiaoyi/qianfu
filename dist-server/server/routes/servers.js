...
import { getMe, listMyServers, listAllServers, createServer, updateServer, getServer, listVersions, compareServerVersions, rollbackServer, checkServerStatus, deleteServer, } from '../controllers/servers';
import { getPlayerHistory, listServerComments, postServerComment, deleteServerComment, toggleServerLike, getServerLikeState, } from '../controllers/serverSocialController';
...
import { checkStatusQuerySchema, compareVersionsQuerySchema, idParamSchema, myServersQuerySchema, paginationQuerySchema, playerHistoryQuerySchema, rollbackSchema, serverCommentBodySchema, serverCommentDeleteParamSchema, serverHistoryQuerySchema, serverSchema, } from '../utils/validation';
const router = Router();
