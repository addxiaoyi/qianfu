...
import { createPayment, getUserPayments, xpayNotify, payProNotify, getPaymentStatus, cancelPayment, manualCompletePayment, getPaymentStats, getAllPayments } from '../controllers/paymentController';
import { authenticate, authorize } from '../middleware/auth';
import { requireVerifiedEmail } from '../middleware/emailVerifiedGuard';
import { csrfProtection } from '../middleware/csrf';
import { paymentLimiter, adminLimiter } from '../middleware/rateLimiter';
...
import { manualPaymentSchema, paymentCreateSchema, paymentQuerySchema, paymentCancelParamSchema, paymentStatsQuerySchema, paymentStatusParamSchema, payProNotifySchema, xpayNotifySchema, } from '../utils/validation';
const router = Router();
