...
import { announcementCreateSchema, announcementIdSchema, announcementUpdateSchema, createAnnouncement, deleteAnnouncement, getCurrentAnnouncement, listPublicAnnouncements, listAnnouncements, updateAnnouncement, } from '../services/announcementService.js';
...
export async function getPublicAnnouncements(_req, res, next) {
    try {
