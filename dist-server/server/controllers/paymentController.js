...
import { paymentCreateSchema, manualPaymentSchema, payProNotifySchema, xpayNotifySchema, paymentQuerySchema, paymentCancelParamSchema, paymentStatusParamSchema, paymentStatsQuerySchema } from '../utils/validation';
import { generateTransactionSignature } from '../lib/wallet';
import { redisService } from '../services/redisService';
import { yuanToFen, fenToYuanNumber } from '../utils/currency';
import { buildDateRange, buildKeywordOrConditions, buildPagination, resolveSortField, resolveSortOrder, } from '../utils/queryBuilder';
import { logger } from '../utils/logger';
import { EXTERNAL_PAYMENT_METHODS, evaluatePaymentGuardrails, isExternalPaymentMethod, } from '../services/paymentGuardrails';
import { resolvePaymentCancelAction } from '../services/paymentCancelPolicy';
import { buildPayProNotifyReplayKey, buildXpayNotifyReplayKey, extractRequestClientIp, isNotifyIpAllowed, resolveNotifyIpAllowlist, } from '../services/paymentCallbackSecurity';
...
const buildPayProNotifyUrl = (req) => {
...
const createPayProPayment = async (req, payment, amount, paymentMethod) => {
