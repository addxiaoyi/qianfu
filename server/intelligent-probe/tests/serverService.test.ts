...
describe('serverService', () => {
  ...
  it('should create a new server', async () => {
    ...
    const result = await createServer(newServerData as any);
  ...
  it('should update an existing server', async () => {
    ...
    (prisma.server.update as any).mockResolvedValue(updatedServer);
  ...
  it('should delete a server', async () => {
    ...
    (prisma.server.delete as any).mockResolvedValue(deletedServer);
