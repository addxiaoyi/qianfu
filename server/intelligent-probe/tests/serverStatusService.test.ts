...
import {
  createServerStatus,
  getServerStatusById,
  getServerStatusByServerId,
  updateServerStatus,
  deleteServerStatus,
} from '../services/serverStatusService.js';
...
describe('serverStatusService', () => {
  ...
  it('should create a new server status', async () => {
    ...
    (prisma.serverStatus.create as any).mockResolvedValue(mockServerStatus);
    ...
    const result = await createServerStatus(newServerStatusData as any);
  ...
  it('should get server status by ID', async () => {
    ...
    (prisma.serverStatus.findUnique as any).mockResolvedValue(mockServerStatus);
  ...
  it('should update an existing server status', async () => {
    ...
    (prisma.serverStatus.update as any).mockResolvedValue(updatedServerStatus);
  ...
  it('should delete a server status', async () => {
    ...
    (prisma.serverStatus.delete as any).mockResolvedValue(deletedServerStatus);
