...
export const createServerController = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getServerByIdController = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const getAllServersController = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const updateServerController = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteServerController = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
