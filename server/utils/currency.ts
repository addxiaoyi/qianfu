 ...
 */
export const parseAmount = (input: number | string): number => {
 ...
 */
export const fenEquals = (a: number, b: number): boolean => {
  return a === b;
};
 ...
 * @returns Sum in fen
 */
export const fenAdd = (a: number, b: number): number => {
  return a + b;
};
 ...
 */
export const fenSubtract = (a: number, b: number): number => {
  return a - b;
};
