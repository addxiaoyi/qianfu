...
import { sendAdminBroadcastEmail, sendDiagnosticEmail } from '../services/emailService';
import {
  deleteMailRecipientGroup,
  deleteMailSchedule,
  deleteMailTemplate,
  importMailLibrary,
  listMailLibrary,
  recordMailHistory,
  upsertMailRecipientGroup,
  upsertMailSchedule,
  upsertMailTemplate,
} from '../services/mailLibraryService';
...
export const getMailConfig = async (_req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const getMailLibrary = async (_req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const updateMailConfig = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    ...
    if (!nextConfig.smtpPass && !nextConfig.clearSmtpPass) {
      delete (nextConfig as Partial<typeof nextConfig>).smtpPass;
    }
    delete (nextConfig as Partial<typeof nextConfig>).clearSmtpPass;
...
export const sendMailConfigTest = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const sendMailBroadcast = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const upsertMailTemplateEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const deleteMailTemplateEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    await deleteMailTemplate(req.params.key);
    return sendSuccess(res, { key: req.params.key }, 'Mail template deleted', 200, undefined, { mask: false });
  } catch (error) {
    return next(error);
  }
};

export const upsertMailRecipientGroupEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const deleteMailRecipientGroupEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    await deleteMailRecipientGroup(req.params.key);
    return sendSuccess(res, { key: req.params.key }, 'Mail recipient group deleted', 200, undefined, { mask: false });
  } catch (error) {
    return next(error);
  }
};

export const upsertMailScheduleEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const deleteMailScheduleEntry = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    await deleteMailSchedule(req.params.key);
    return sendSuccess(res, { key: req.params.key }, 'Mail schedule deleted', 200, undefined, { mask: false });
  } catch (error) {
    return next(error);
  }
};

export const importMailLibraryEntries = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
