...
import { getModerationConfigs, setConfig } from '../services/configService';
import { ModerationService } from '../services/moderationService';
import prisma from '../db';
import { sendSuccess, sendPaginated } from '../utils/response';
import { AppError, ErrorCode } from '../utils/errors';
import { logDataChange } from '../services/auditService';
import { updateModerationSettingSchema, moderationLogQuerySchema, reviewModerationLogSchema, idParamSchema } from '../utils/validation';

/**
 * Get list of moderation settings (Admin only)
 */
export const getModerationSettings = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const updateModerationSetting = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getModerationLogs = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
