...
import { promoClaimSchema, promoIdempotencyKeySchema } from '../schemas/promoSchemas';
import { createPendingPromoClaim } from '../services/promoClaimService';
import { AppError, ErrorCode } from '../utils/errors';
import { sendCreatedResponse, sendSuccess } from '../utils/response';

export const submitPromoClaim = async (
  req: AuthRequest,
  res: Response,
  next: NextFunction,
): Promise<unknown> => {
