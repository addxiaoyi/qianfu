 ...
 */
export async function getConfig(key: string, decryptValue = false): Promise<string | null> {
  try {
 ...
 */
export async function setConfig(key: string, value: string, isSecret = false, description?: string): Promise<void> {
  try {
