...
export function formatAiRegistryForPrompt(maxChars = 12000): string {
...
export function formatAiRegistrySubsetForPrompt(ids: readonly number[], maxChars = 9000): string {
