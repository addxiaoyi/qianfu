...
function getErrorIconSvg(statusCode: number): string {
...
export const port5555SecurityRedirect = (req: Request, res: Response, next: NextFunction) => {
...
export const createPort5555ErrorRoutes = (app: any) => {
  app.get('/errors/port5555-unauthorized', (req: Request, res: Response) => {
    res.status(403).send(`
<!DOCTYPE html>
<html lang="en">
<head>
