  ...
  return (
    <>
      <motion.button
        ...
        transition={{ delay: 1 }}
        className="fixed bottom-40 right-4 z-[200] w-14 h-14 bg-accent text-white rounded-[1.5rem] flex items-center justify-center shadow-2xl shadow-accent/30 transition-all duration-300 hover:scale-110 active:scale-95 group sm:bottom-8 sm:right-8"
        title={t('common.settings')}
      >
        <GeometricLantern variant="settings" className="w-6 h-6 group-hover:rotate-45 transition-transform duration-500" />
      </motion.button>
        ...
        {isPanelVisible && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-40 left-4 right-4 z-[220] max-h-[calc(100vh-11rem)] overflow-y-auto bg-white rounded-[2.5rem] shadow-2xl shadow-black/20 border border-zinc-100 sm:bottom-8 sm:left-auto sm:right-8 sm:w-80 sm:max-h-none sm:overflow-hidden"
            >
              <div className="p-6 sm:p-8 border-b border-zinc-50 flex items-center justify-between">
                ...
                >
                  <GeometricLantern variant="close" className="w-5 h-5 group-hover:rotate-90 transition-transform duration-300" />
                </button>
              </div>

              <div className="p-6 sm:p-8 space-y-5 border-b border-zinc-50">
                <div className="flex items-center gap-3">
                  <GeometricLantern variant="user" className="w-4 h-4 text-zinc-300" />
                ...
                <div className="grid grid-cols-2 gap-3">
                  {SUPPORTED_LOCALES.map((loc) => (
                    ...
                    >
                      {locale === loc.id && (
                        <div className="absolute top-2 right-2"><GeometricLantern variant="check" className="w-3 h-3 text-white/70" /></div>
                      )}
                    ...
                    >
                      {accent === id && (
                        <div className="absolute top-1.5 right-1.5">
                          <GeometricLantern variant="check" className="w-3 h-3 text-zinc-600" />
                        </div>
                      )}
                      <div
              ...
              <div className="px-6 sm:px-8 pb-6 flex items-center justify-center gap-3 text-[9px] font-black text-zinc-200 uppercase tracking-widest italic">
