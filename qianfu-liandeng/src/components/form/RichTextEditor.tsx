...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ value, onChange, placeholder }) => {
  ...
  const onEditorDrop = (event: React.DragEvent<HTMLDivElement>) => {
  ...
  return (
    <div className="matrix-card !p-0 overflow-hidden group/editor">
      ...
      {/* Editor Content */}
      <div className="relative group min-h-[280px]" onDragOver={(event) => event.preventDefault()} onDrop={onEditorDrop} onPaste={onEditorPaste}>
        ...
        {isUploadingImage && <div className="absolute right-4 top-4 rounded-full bg-black px-3 py-1 text-[10px] font-black uppercase tracking-widest text-white">图片上传中</div>}
