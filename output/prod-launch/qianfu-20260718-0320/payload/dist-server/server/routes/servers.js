...
import { getPlayerHistory, listServerComments, postServerComment, deleteServerComment, toggleServerLike, getServerLikeState, toggleServerFavorite, getServerFavoriteState, listMyFavoriteServers, } from '../controllers/serverSocialController.js';
 ...
 *         description: Authentication required
 */
router.post('/servers', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateBody(serverSchema), createServer);
/**
 * @swagger
 ...
 *         description: Server not found
 */
router.put('/servers/:id', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(idParamSchema), validateBody(serverSchema), updateServer);
/**
 * @swagger
 ...
 *         description: Not authorized
 */
router.post('/servers/:id/rollback', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(idParamSchema), validateBody(rollbackSchema), hasPermission(['manage_content']), rollbackServer);
/**
 * @swagger
 * /api/servers/servers/{id}:
 *   delete:
 ...
 *         description: Validation error
 */
router.post('/servers/:id/comments', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(idParamSchema), validateBody(serverCommentBodySchema), hasPermission(['comment_servers']), postServerComment);
/**
 * @swagger
 ...
 *         description: Not authorized
 */
router.delete('/servers/:id/comments/:commentId', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(serverCommentDeleteParamSchema), deleteServerComment);
/**
 * @swagger
 ...
 *         description: Authentication required
 */
router.post('/servers/:id/like', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(idParamSchema), toggleServerLike);
/**
 * @swagger
 * /api/servers/servers/{id}/favorite:
 *   post:
 *     summary: Toggle server favorite
 *     tags: [Servers]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: Authentication required
 */
router.post('/servers/:id/favorite', serversLimiter, authenticate, requireVerifiedEmail, writeCsrf, validateParams(idParamSchema), toggleServerFavorite);
/**
 * @swagger
 * /api/servers/servers/{id}/favorite-state:
 *   get:
 *     summary: Get current user's favorite state for a server
 *     tags: [Servers]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 */
router.get('/servers/:id/favorite-state', serversLimiter, validateParams(idParamSchema), getServerFavoriteState);
/**
 * @swagger
 * /api/servers/me/favorites:
 *   get:
 *     summary: List current user's favorite servers
 *     tags: [Servers]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Favorite servers list
 *       401:
 *         description: Authentication required
 */
router.get('/me/favorites', serversLimiter, authenticate, validateQuery(paginationQuerySchema), listMyFavoriteServers);
/**
 * @swagger
