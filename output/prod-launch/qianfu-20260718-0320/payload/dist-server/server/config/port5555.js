...
export const PORT_5555_CONFIG = {
    ...
    REQUIRED_PERMISSIONS: ['port5555_access'],
...
export const validatePort5555Access = (userRole, userPermissions) => {
...
export const getPort5555AccessInfo = (userRole, userPermissions) => {
