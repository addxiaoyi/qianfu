...
export const promoBindingLimiter = createRateLimiter({
    windowMs: 15 * 60 * 1000,
    max: process.env.NODE_ENV === 'production' ? 10 : 100,
    message: 'Platform binding attempts are too frequent',
    prefix: 'rl:promo_binding:',
    keyStrategy: 'userOrIp',
});
export const promoClaimLimiter = createRateLimiter({
    windowMs: 15 * 60 * 1000,
    max: process.env.NODE_ENV === 'production' ? 20 : 200,
    message: 'Promotion claim attempts are too frequent',
    prefix: 'rl:promo_claim:',
    keyStrategy: 'userOrIp',
});
