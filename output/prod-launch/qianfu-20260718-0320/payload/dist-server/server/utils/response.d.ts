...
import { maskEmail as maskEmailUtil, maskPhone as maskPhoneUtil } from './masking';
 ...
 */
export declare const sendSuccess: <T>(res: Response, data: T, message?: string, statusCode?: number, meta?: Record<string, unknown>, options?: ResponseSendOptions) => Response<any, Record<string, any>>;
/**
...
export declare const maskEmail: typeof maskEmailUtil;
export declare const maskPhone: typeof maskPhoneUtil;
